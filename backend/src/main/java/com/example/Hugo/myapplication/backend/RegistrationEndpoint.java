...
public class RegistrationEndpoint {
    ...
    public void registerDevice(@Named("regId") String regId, @Named("phone") String phone) {
        if (findRecord(regId) != null) {
            log.info("Device " + regId + " already registered, skipping register");
            return;
        }
        if (findRecord(phone) != null){
            log.info("Number " + phone + " someone already has this number");
            return;
        }
